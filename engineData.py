...
def readText(stream):
    ...
    sig1 = str(stream.read(1))[2:-1]
    sig2 = str(stream.read(1))[2:-1]
...
def getFontAndColorDict(propDict, engineData):
    stream = io.BytesIO(engineData)
    
    while True:
        
        # if we reach the end
        if stream.tell() == (len(engineData) - 1):
            break
        ...
        if c == '/':
            ...
            if prop == 'FontSet' and propDict['FontSet'] == '':
                ...
                print(propDict['FontSet'])

            if prop == 'FontType'and propDict['FontType'] == '':
                propDict['FontType'] = readTextFont(stream)
                if prop == 'FontType' and propDict['FontTypeA'] == '' and propDict['FontSet'] == 'AdobeInvisFont':
                    propDict['FontSet'] = readTextFont(stream)
                print(propDict['FontType'])
            ...
            if prop == 'FontSize' and propDict['FontSize'] == '':
                ...
                print(propDict['FontSize'])
                
            if prop == 'Values' and propDict['R'] == '':
                argb = readARGB(stream)
                argb = argb.split()
                propDict['A'] = int(float(argb[0]))
                propDict['R'] = int(float(argb[1]) * 255)
                propDict['G'] = int(float(argb[2]) * 255)
                propDict['B'] = int(float(argb[3]) * 255)
